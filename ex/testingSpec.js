...
describe("#replaceWith", function () {
    ...
    it("replaces a character with another character", function () {
        expect(replaceWith("awesome", "e", "z")).to.equal("awzsomz")
    });

    it("does not care about case sensitive ", function () {
        expect(replaceWith("awEsome", "e", "z")).to.equal("awzsomz")
    });
...
describe("#expand", function () {
    ...
    it("copies an array a certain number of times", function () {
        expect(expand([1, 2, 3])).to.deep.equal([1, 2, 3, 1, 2, 3, 1, 2, 3])
    });
...
describe("#acceptNumbersOnly", function () {
    ...
    it("returns false if all of them are numbers", function () {
